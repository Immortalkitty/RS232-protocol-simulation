...
namespace Zad4_RS232
{
    public partial class Receiver : Form
    {
        ...
        string textInBinary = "";
        string[] badWords = File.ReadAllLines("../../../badWords.txt");
        ...
        string DecodeRS232Frame()
        {
            ...
            //censoring
            string stars = "";
            string censoredText = decodedText;
            ...
            foreach (string word in dictionary)
            {
                ...
                censoredText = Regex.Replace(censoredText, word, stars, RegexOptions.IgnoreCase);
